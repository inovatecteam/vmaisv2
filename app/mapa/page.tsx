      ...
      <div className="pt-32 pb-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            {/* Mapa e Lista de ONGs - Right side, spans 2 columns on desktop */}
            <div className="lg:col-span-2 order-2 space-y-4 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-6">
              {/* Mapa */}
              <div className="h-96 lg:h-auto lg:min-h-[600px]">
              ...
              {/* Lista de ONGs - Right side of map on desktop */}
              <div className="h-96 lg:h-auto lg:min-h-[600px]">
                <Card className="rounded-2xl shadow-xl shadow-gray-200/50 flex-1 flex flex-col min-h-0 h-full">
